...
class ManipStationPlanRunner(LeafSystem):
    ...
    def __init__(self, station, kuka_plans, gripper_setpoint_list,
        ...
        self.current_gripper_setpoint = self.gripper_setpoint_list[0]

        # calculate starting time for all plans, FYI only.
    ...
    def GetCurrentPlan(self, context):
        ...
        if t - self.current_plan_start_time >= self.current_plan.duration or self.has_new_plan:
